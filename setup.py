test = {
    ...
    "LF1822": {
        ...
        "Back Face": dict(
            curvature=-500, konic=0, aperture_radius=25.4 / 2, z_0=23
        ),
        "Material": "BK7",
        "Calibration": False,
    },
    "Aspheric": {
        "Front Face": dict(
            curvature=1e20, konic=0, aperture_radius=160, z_0=30
        ),
        "Back Face": dict(
            curvature=-329.767,
            konic=-0.604045,
    ...
    "Sensor": {
        "Front Face": dict(
            curvature=float("inf"), konic=0, aperture_radius=160, z_0=1000
        ),
        "Back Face": dict(
            curvature=float("inf"),
            konic=0,
